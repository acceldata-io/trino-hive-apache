            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new ArrayList<String>(_list848.size);
                String _elem849;
                for (int _i850 = 0; _i850 < _list848.size; ++_i850)
                {
                  _elem849 = iprot.readString();
                  struct.processorCapabilities.add(_elem849);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter851 : struct.processorCapabilities)
            {
      ...
      if (struct.isSetProcessorCapabilities()) {
        {
          ...
          for (String _iter852 : struct.processorCapabilities)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.processorCapabilities = new ArrayList<String>(_list853.size);
          String _elem854;
          for (int _i855 = 0; _i855 < _list853.size; ++_i855)
          {
            _elem854 = iprot.readString();
            struct.processorCapabilities.add(_elem854);
          }
        }
        struct.setProcessorCapabilitiesIsSet(true);
      }
